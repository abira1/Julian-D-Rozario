...
import FirebaseBlogEditor from './admin/FirebaseBlogEditor';
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-slate-950 to-black">
      ...
      <div className="pt-16">
        <Routes>
          ...
          <Route path="/blog-editor" element={<FirebaseBlogEditor />} />
          <Route path="/blog-editor/:blogId" element={<FirebaseBlogEditor />} />
